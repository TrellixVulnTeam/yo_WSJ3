...
function error_ajax() {
    alerta( "danger", "ERROR", "Hubo algún problema con el componente AJAX" );
}

function alerta( tipo, aviso, mensaje ) {
    $( "#mensaje" ).append( '<div class="alert alert-'+ tipo +
    'alert-dismissible fade show" role="alert">  <strong>¡' + aviso + 
    '!</strong> '+ mensaje +'.<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>' );
